...
#            "04_Main_Section_4_3.py"
# 
# DO NOT run this script independently! It must be used in conjunction with
# the Python file "04_Main_Section_4_3.py" for full reproducibility.
# 
# Usage:
#   1. Run "04_Main_Section_4_3.py" first to generate necessary data
...
# ----------------------------------------------------------------------------
# 2. Data Processing Function (Does not set `ref` for complex variables, ensuring the model operates correctly.)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# 4. Execute predictions and generate data tables.
# ----------------------------------------------------------------------------
