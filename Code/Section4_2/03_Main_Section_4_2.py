...
try:
    from Auxiliary1_Custom_Functions import *
...
# ECONOMETRIC
r_script_path = os.path.join(r_script_dir, 'Auxiliary2_Section_4.2.R')
...
# ECO
r_script_path_wta = os.path.join(r_script_dir, 'Auxiliary3_Section_4.2.R')
